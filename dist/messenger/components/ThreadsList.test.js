...
describe('ThreadsList', () => {
    it('renders fetched threads as list items', async () => {
        ...
        render(_jsx(MessengerProvider, { adapter: adapter, currentUserId: 1, children: _jsx(ThreadsList, { onSelectThread: onSelect }) }));
...
//# sourceMappingURL=ThreadsList.test.js.map